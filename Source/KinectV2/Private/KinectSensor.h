...
public:
	...
	bool IsAvailabilityChanged() const { return isAvailabilityChanged; }
	bool KinectIsAvailable() { isAvailabilityChanged = false; return sensorState == TRUE; }

private:

	bool isAvailabilityChanged = false;
...
private:
	...
	WAITABLE_HANDLE			AvailableChangeEventHandle;
...
private:
	...
	FRunnableThread*		pKinectThread = nullptr; ///< The kinect thread
